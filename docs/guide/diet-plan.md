...
1. Navigate to the **Diet Plan** tab in the bottom navigation bar
2. Complete the comprehensive questionnaire (see details below)
3. Wait for the system to generate your customized plan (typically 1-2 minutes)
4. Review your personalized recommendations across three categories: **Diet Plan**, **Supplements**, and **Lifestyle**
...
1. Tap the **Edit Plan** button in the Diet Plan tab, or
2. Go to Profile > Edit Diet Plan
3. Complete the questionnaire again with any updated information
4. Submit to generate a fresh 28-day plan
